...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val textView: TextView = findViewById<TextView>(R.id.guessWord)

        val hiddenWord = findViewById<TextView>(R.id.hiddenWord)
        ...
        button.setOnClickListener (View.OnClickListener() {
            if (count <= 3) {
                val guess: String = textView.text.toString()
                val output = checkGuess(guess, wordToGuess)
